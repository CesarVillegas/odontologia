...
) ENGINE=InnoDB AUTO_INCREMENT=282 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `noticia_noticia` VALUES (1,'Gran éxito en el tratamiento de pacientes con necesidades diferentes.','<p>El alumno conoce conceptos importantes con respecto a discapacidad (talleres con metodolog&iacute;as activas de aprendizaje), aspectos sicosociales que rodean el entorno del paciente. Comprende y adquiere conceptos para el manejo de los pacientes especiales, confecciona una adecuada ficha cl&iacute;nica y puede desarrollar un plan de tratamiento preventivo individualizado para cada paciente. En cl&iacute;nica logra atender pacientes con necesidades especiales en salud, tanto en actividades preventivas como rehabilitadoras simples.</p>','2019-04-08 03:00:00.000000','2019-07-08 04:00:00.000000','noticias/pacientes_con_necesidades_especiales_640x480.jpg',1);
...
-- Dump completed on 2020-11-06 19:52:52
