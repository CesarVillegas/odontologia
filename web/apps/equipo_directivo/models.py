...
# Clase para los directivos de la carrera
class Directivo(models.Model):
    ...
    tipo_cargo = models.CharField(max_length=1, choices=TIPO_DIRECTIVO, blank=False, null=False, default='G')
    foto = models.ImageField(upload_to='equipo_directivo/directivos/', height_field=None, width_field=None, max_length=100, validators=[validate_image_docente], help_text='Tamano maximo de la imagen es 1Mb, sus dimensiones deben ser de 270x270 pixeles')
